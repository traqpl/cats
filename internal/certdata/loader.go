...
// _masks must match masks in cmd/certgen/main.go.
var _masks = [4]uint64{
	0x48A5C3D2F1E6B790,
	0x2C7E91F4A836D05B,
	0xF3821C0ED7594A6E,
...
// Generated by cmd/certgen into internal/certdata/encrypted.go.
var (
	_kp      [4]uint64
	_nonce1  [12]byte
	_nonce2  [12]byte
...
var ErrNoCertData = errors.New("certdata: no embedded certificate data")
